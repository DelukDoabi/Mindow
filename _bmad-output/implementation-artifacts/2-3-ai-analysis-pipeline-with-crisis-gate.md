...
- [ ] **Task 6 — Crisis UX + support resources** (AC: #2)
  ...
  - [ ] The captured Preoccupation that triggered crisis detection: keep it as a pending item with no weight (it was already captured in 2.2) — do NOT auto-delete (delete is 2.4). (Resolved Decision #7.)
